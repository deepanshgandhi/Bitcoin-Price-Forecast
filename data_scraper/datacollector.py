...
def get_dates(queue, start_date='2010/07/17', end_date='2021/07/19'):
...
def get_data(start_date='2010/07/17', end_date='2010/07/19'):
    '''
...
if __name__ == '__main__':
    get_data(start_date='2010/07/17', end_date='2021/07/19')
